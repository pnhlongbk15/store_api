        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllInStock = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ByProductDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ByProductDetails_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ByProductDetailId = table.Column<string>(type: "varchar(255)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetailCarts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetailCarts_ByProductDetails_ByProductDetailId",
                        column: x => x.ByProductDetailId,
                        principalTable: "ByProductDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetailCarts_Carts_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ByProductDetails_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetailCarts_ByProductDetailId",
                table: "DetailCarts",
                column: "ByProductDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_DetailCarts_OrderId",
                table: "DetailCarts",
                column: "OrderId");
